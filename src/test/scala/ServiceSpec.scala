...
class ServiceSpec extends FlatSpec with Matchers with ScalatestRouteTest with Service {
  ...
  val ip1Info = IpInfo(None, Option("Mountain View"), Option("United States"), Option("US"), None, Option(37.386), Option(-122.0838), None, None, None, "8.8.8.8", None, None, None, "Success", None, None)
  val ip2Info = IpInfo(None, Option("Mountain View"), Option("United States"), Option("US"), None, Option(38.0), Option(-97.0), None, None, None, "8.8.4.4", None, None, None, "Success", None, None)
